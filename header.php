...
<html lang="en">
  ...
  <body>
    <header class="container horizontal">
      ...
      >
        <svg
          ...
          viewBox="0 0 234.747 231.296"
          xml:space="preserve"
        >
          <path
            d="M74.762,106.255c0-23.534,19.078-42.611,42.611-42.611c23.534,0,42.612,19.077,42.612,42.611
          ...
          />
          <path
            d="M117.373,63.644c-23.533,0-42.611,19.077-42.611,42.611c0,0.664,0.02,1.323,0.05,1.979
          ...
          />
          <path
            d="M117.373,77.943c-15.635,0-28.311,12.676-28.311,28.312c0,0.94,0.049,1.869,0.138,2.785
          ...
          />
          <path
            d="M190.749,94.684c-1.743-0.412-2.536,1.648-4.817,4.438c-1.109,1.331-2.567,2.885-4.66,4.374
    ...
    <nav class="container horizontal">
      <a href="/attractions.php" target="_blank" rel="noopener noreferrer">
        Attractions
      </a>
      <a href="/about.php" target="_blank" rel="noopener noreferrer">
        About Us
      </a>
      <a href="/my_reservation.php" target="_blank" rel="noopener noreferrer">
        Attractions
      </a>
