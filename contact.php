...
<!DOCTYPE html>
<html lang="en">
<!--Code to Handele Incoming Message Here - Maybe relay to email?-->
<head>
  ...
  <main>
    ...
    <?php }else{ ?>
     ...
     <form action="contact.php" method="post" style="font-size:0.8em;clear:both;margin-left:6px">
      Name: <input required type="text" name="name"/>  Email: <input required type="text" name="email"/> Phone (optional): <input type="text" name="phone"/>
